...
import 'package:mobile/modules/campaign/widgets/set/date_range_picker_sheet.widget.dart';
...
class _DateRangePickerState extends State<DateRangePicker> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: BlocBuilder<SetCampaignBloc, SetCampaignState>(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(
                    color: state.dateRangeError != null
                        ? Colors.red
                        : ColorStyles.gray200,
                  ),
